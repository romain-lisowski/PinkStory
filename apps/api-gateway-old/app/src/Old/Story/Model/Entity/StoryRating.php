 ...
 * @ORM\Entity(repositoryClass="App\Story\Repository\Entity\StoryRatingRepository")
 * @UniqueEntity(
 *      fields = {"story", "user"}
 * )
 */
class StoryRating extends AbstractEntity implements UserEditableInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Story\Model\Entity\Story", inversedBy="storyRatings")
